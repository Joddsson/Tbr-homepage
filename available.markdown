		...
		<div class="tabbable">
			...
			<div class="tab-content">
				<div class="tab-pane active" id="tab1">
					<h3 class="board_text">Lausir tímar á mánudögum veturinn 2017-2018</h3>
					...
					<div class="table-responsive">
						<table class="table table-hover" id="house2">
							...
							<tbody>
								...
								<tr>
									<td><i class="fa fa-clock-o"></i> <b>21:50</b></td>
									<!--<td>&nbsp;</td>-->
								</tr>
								<tr>
									<td>&nbsp;</td>
				...
				<div class="tab-pane" id="tab3">
					<h3 class="board_text">Lausir tímar á miðvikudögum veturinn 2017-2018</h3>
					<div class="table-responsive">
						<table class="table table-hover" id="house1">
							<thead>
								<tr>
				...
				<div class="tab-pane" id="tab4">
					<h3 class="board_text">Lausir tímar á fimmtudögum veturinn 2017-2018</h3>
					<div class="table-responsive">
						<table class="table table-hover" id="house1">
							<thead>
								<tr>
				...
				<div class="tab-pane" id="tab5">
					<h3 class="board_text">Lausir tímar á föstudögum veturinn 2017-2018</h3>
					<div class="table-responsive">
						<table class="table table-hover" id="house1">
							<thead>
								<tr>
							...
							<tbody>
								...
								<tr>
									<td><i class="fa fa-clock-o"></i> <b>13:00</b></td>
								</tr>
								<tr>
									<td><i class="fa fa-clock-o"></i> <b>16:20</b> <i class="fa fa-long-arrow-right"></i> 20% afsláttur af föstum tímum.</td>
								</tr>
					...
					<div class="table-responsive">
						<table class="table table-hover">
							...
							<tbody>
								...
								<tr>
									<td><i class="fa fa-clock-o"></i> <b>10:00</b></td>
								</tr>
								<tr>
...
<!--
DISCOUNT RULES:
20%  á virkum dögum:  08.50,09.40,10.30,11.20 og kl. 13.00 og 16.20
50% 21.50
50% á föstudögum 19.40,20.30.21.20 og 19.20,20.10,21.00
50% á laugardögum:  11.40 og síðar
50% alla sunnudaginn
-->
